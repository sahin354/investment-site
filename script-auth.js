...
// const functions = firebase.functions(); // Uncomment if you use functions here
...
function mobileToEmail(mobileNumber) {
    ...
    // REPLACE 'yourdomain.com' with your unique identifier
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            if (!mobileInput || !passwordInput) {
                alert("Login form error: Missing inputs.");
                return;
            }
            ...
            try {
                ...
                // Success! onAuthStateChanged will handle the rest, or redirect here:
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                // REMOVED: await isMobileNumberRegistered(...) -> This was causing the error!
                // Firebase Auth will automatically error if the email (mobile) exists.
