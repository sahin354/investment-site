...
// --- UPDATED: Render Users Table with Email Links ---
function renderUsersTable() {
    ...
    // NEW: Add click listeners for email links
...
// --- NEW FUNCTIONS: User Details Modal ---
...
function saveUserBankDetails() {
    const userId = document.getElementById('saveBankDetailsBtn').dataset.userid || currentSelectedUserId;
    if (!userId) {
